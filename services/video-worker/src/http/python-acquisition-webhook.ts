...
> = {
  accepted: {
    severity: "info",
    message: "The protected Python acquisition engine accepted this source.",
  },
  extracting: { severity: "info", message: "Reading the authorised YouTube source metadata." },
  downloading: {
    severity: "info",
    message: "Downloading the plan-capped source through protected egress.",
  },
  postprocessing: {
    severity: "info",
    message: "Finalising the downloaded source media with FFmpeg.",
  },
  completed: {
    severity: "info",
    message: "The protected source download completed and is being validated.",
  },
  failed: {
    severity: "warning",
    message:
