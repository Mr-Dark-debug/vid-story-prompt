...
export function UseCaseTemplate({
  ...
  return (
    <MarketingLayout>
      ...
      <Section>
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-2xl border border-line bg-surface-panel p-6">
            <div className="text-[11px] font-medium uppercase tracking-widest text-ink-mute">
              Scenario
            </div>
          ...
          <div className="rounded-2xl border border-line bg-surface-panel p-6">
            ...
            <ul className="mt-3 space-y-2">
              {prompts.map((p) => (
                <li
                  key={p}
                  className="rounded-md border border-line bg-surface-page px-3 py-2 text-sm text-ink"
                >
                  {p}
                </li>
              ))}
        ...
        <div className="mt-10">
          ...
          <ul className="grid gap-2 sm:grid-cols-2">
            {outcomes.map((o) => (
              <li
                key={o}
                className="flex items-start gap-2 rounded-xl border border-line bg-surface-panel px-4 py-3 text-sm text-ink-soft"
              >
      ...
      <FinalCTA headline="Start with one video. Create your first clips." />
    </MarketingLayout>
  );
}
