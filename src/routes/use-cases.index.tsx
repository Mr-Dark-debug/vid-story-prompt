...
const cases = [
  {
    ...
    i: Youtube,
    t: "YouTube videos",
    d: "Tighten explainers and interviews without losing your voice.",
  },
  {
    to: "/use-cases/podcasts",
    i: Mic,
    t: "Video podcasts",
    d: "Cut the room silence, keep the conversation.",
  },
  {
    to: "/use-cases/short-form",
    i: Smartphone,
    t: "Short-form clips",
    d: "Turn long-form into vertical hooks fast.",
  },
  {
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {cases.map((c) => (
            <Link
              key={c.to}
              to={c.to}
              className="group rounded-2xl border border-line bg-surface-panel p-6 hover:border-line-strong"
            >
