...
export const Route = createFileRoute("/youtube-clipper")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Find complete moments in long videos, correct captions and export editable clips for YouTube Shorts, Instagram Reels and TikTok." },
      { property: "og:title", content: "YouTube Clipper — Turn Long Videos Into Shorts | Vidrial" },
      { property: "og:description", content: "Find complete moments in long videos, correct captions and export editable clips for YouTube Shorts, Instagram Reels and TikTok." },
