...
export const clipJobStatuses = [
  "draft", "awaiting_source", "uploading", "queued", "validating", "creating_proxy",
  "extracting_audio", "transcribing", "analysing", "planning", "rendering_previews",
  "ready", "partially_ready", "exporting", "completed", "failed", "cancelled",
  "expiring", "expired",
] as const;
export type ClipJobStatus = (typeof clipJobStatuses)[number];

export const taskStatuses = [
  "pending", "queued", "leased", "running", "retry_wait", "succeeded", "failed",
