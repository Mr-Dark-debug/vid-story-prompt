...
export type Database = {
  public: {
    Tables: {
      ...
      automation_events: GeneratedTable<{
        id: string;
        workspace_id: string;
        youtube_channel_id: string;
        automation_rule_id: string | null;
      ...
      publishing_jobs: GeneratedTable<{
        id: string;
        workspace_id: string;
        user_id: string;
        clip_job_id: string;
      ...
      youtube_asset_links: GeneratedTable<{
        id: string;
        workspace_id: string;
        user_id: string;
        youtube_channel_id: string;
      ...
      youtube_channels: GeneratedTable<{
        id: string;
      ...
      youtube_subscriptions: GeneratedTable<{
        id: string;
        workspace_id: string;
        youtube_channel_id: string;
        hub_topic: string;
